    ...
    def add_knowledge(self, cell, count):
        ...
        for sentence1 in self.knowledge:
            ...
            for sentence2 in self.knowledge:
                if sentence1 == sentence2 or not sentence2.cells:
                    continue
                if sentence1.cells < sentence2.cells:
                    ...
                    if new_inference not in self.knowledge and new_inference not in new_inferences:
                        new_inferences.append(new_inference)
        self.knowledge.extend(new_inferences)

    def update_knowledge_base(self):
        """
        Updates the knowledge base by marking cells as safe or as mines
        if it can be concluded based on the AI's knowledge base.
        """
        all_safes = set()
        all_mines = set()
